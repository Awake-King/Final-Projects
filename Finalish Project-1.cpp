...

{
	...
	do
	{
		...
		else if(userAnswer == -1)
		{
			...
			cout << "What you entered is not in our system." << endl;
...
void onlineInfo() //*****Start of onlineInfo function*****
{
	...
	cout << "Warning! Websites will automatically open." << endl << endl;
	...
	while(userAnswer != -1)
	{
		if(userAnswer == 1)
		{
			cout << "For more information on blood sugar we're taking you to:" << endl;
			cout << "http://www.diabetes.org/living-with-diabetes/treatment-and-care/blood-glucose-control/" << endl;
			system("open http://www.diabetes.org/living-with-diabetes/treatment-and-care/blood-glucose-control/");
			
		}
		else if(userAnswer == 2)
		{
			cout << "For more information on your hemoglobin A1C we're taking you to:" << endl;
			cout << "http://www.niddk.nih.gov/health-information/health-topics/diagnostic-tests/a1c-test-diabetes/Pages/index.aspx" << endl;
			system("open http://www.niddk.nih.gov/health-information/health-topics/diagnostic-tests/a1c-test-diabetes/Pages/index.aspx");
		}
		else if(userAnswer == 3)
		{
			cout << "For more information on diet and exercise as a diabetic we're taking you to:" << endl;
			cout << "http://www.diabetes.org/food-and-fitness/" << endl;
			system("open http://www.diabetes.org/food-and-fitness/");
		}
		else if (userAnswer == 4)
		{
			cout << "For specific information on diabetes type 1 we're taking you to:" << endl;
			cout << "http://www.diabetes.org/diabetes-basics/type-1/" << endl;
			system("open http://www.diabetes.org/diabetes-basics/type-1/");
		}
		else if(userAnswer == 5)
		{
			cout << "For specific information on diabetes type 2 we're taking you to:" << endl;
			cout << "http://www.diabetes.org/diabetes-basics/type-2/" << endl;
			system("open http://www.diabetes.org/diabetes-basics/type-2/");
		}//end if
		else
			cout << "What you entered is not in our system, please type one of the following." << endl;
			cout << endl;
			cout << "(-1 to go back to the previous menu.)" << endl;
			cout << "Warning! Program will automatically open." << endl << endl;
			cout << "1: Blood Sugar." << endl;
			cout << "2: Hemoglobin A1C." << endl;
			cout << "3: Diet and exercise." << endl;
			cout << "4: Type 1 diabetes." << endl;
